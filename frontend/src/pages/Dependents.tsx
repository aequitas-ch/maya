    ...
    <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      <div className="px-4 py-6 sm:px-0">
          ...
          <div className="border-t border-gray-300 px-4 py-5 sm:p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-4">
                ...
                >
                  {isSubmitting ? t('loading_data') || 'Saving...' : (editingId ? t('update_dependent') || 'Update Dependent' : t('add') || 'Add Dependent')}
                </button>
                {editingId && (
                  <button
                    type="button"
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-2xl">
          <div className="px-4 py-5 sm:px-6">
            <h2 className="text-lg leading-6 font-medium text-gray-900">{t('your_dependents') || 'Your Dependents'}</h2>
          </div>

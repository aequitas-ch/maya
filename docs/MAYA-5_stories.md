# Epic MAYA-5: Assistenz Modul
Es soll über Maya möglich sein, Assistenz oder anderes Personal anzustellen. Dabei soll unterschieden werden können zwischen,- IV Assistenz (IV Kompatibel)- Hausangestellt (nicht IV Kompatibel, aber mit Vertrag)- Babysitter (ohne Lohnausweis)Das Modul soll den kompletten Life Cycle unterstützen:- Einstellung- Vertrag- monatliche Lohnabrechung- quartal IV Abrechnung- Lohnausweis ende Jahr- EntlassungEs sollen auch alle Nebenkosten definiert werden und eine Liste mit den Angestellten inkl. den Kosten angezeigt werden.Folgende Vorlange:

## Story MAYA-13: Dashboard und Kostenübersicht
...
## Story MAYA-12: Jährlicher Lohnausweis
...
## Story MAYA-11: Quartalsweise IV Abrechnung
...
## Story MAYA-10: Monatliche Lohnabrechnung und Stundenerfassung
...
## Story MAYA-9: Vertragsmanagement und Musterverträge
...
## Story MAYA-8: Verwaltung von Angestellten-Stammdaten (Einstellung & Entlassung)
...
## Ergänzung (aus User Input)
- **Stundenlohn:** Alle Mitarbeiter (unabhängig vom Anstellungstyp) sind ausnahmslos im Stundenlohn angestellt. Monatslöhne werden nicht unterstützt.
